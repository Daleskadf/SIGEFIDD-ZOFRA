<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Historial.aspx.cs" Inherits="ZofraTacna.Presentacion.Historial" ResponseEncoding="utf-8" ContentType="text/html; charset=utf-8" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}html,body{width:100%;height:100%;overflow:hidden}
        ...
        tbody tr{border-bottom:1px solid #f4f5fa}tbody tr:last-child{border-bottom:none}tbody tr:hover{background:#fafbff}
        tbody td{padding:13px 16px;font-size:13px;color:#444;vertical-align:middle}
        .doc-asunto{font-weight:600;color:#1a2a4a;font-size:14px}.doc-archivo{color:#aaa;font-size:11px;margin-top:2px}
        ...
        .btn-dots{background:none;border:1.5px solid #dde1f0;border-radius:6px;width:30px;height:30px;cursor:pointer;font-size:16px;color:#666;display:flex;align-items:center;justify-content:center}
                            ...
                            <asp:Repeater ID="rptDocs" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><%# Eval("FechaStr") %></td>
                                        <td><button type="button" class="btn-dots">&#8230;</button></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                        </tbody>
